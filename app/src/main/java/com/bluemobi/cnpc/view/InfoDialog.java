...
public final class InfoDialog {
    ...
    public InfoDialog addView(View v) {
    ...
    public InfoDialog setTitle(String text) {
        if (titleView == null) {
    ...
    public InfoDialog setTitle(String text,int colorID) {
        if (titleView == null) {
            titleView = createTitleView(text);
        }
    ...
    public InfoDialog setMessage(View messageView) {
        this.messageView = messageView;
        messageView.setPadding(dp20, dp10, dp20, dp10);
        return this;
    }

//    public InfoDialog setMessageFromHtml(String htmlMessage) {
...
//    }
    ...
    public InfoDialog setNegativeButtonClickListener(String text,
    ...
    public InfoDialog setPositiveButtonClickListener(String text,
                                                     View.OnClickListener listener) {
    ...
    public InfoDialog setPositiveButtonText(String text) {
        if (leftButton == null) {
    ...
    public InfoDialog setNegativeButtonText(String text) {
        if (rightButton == null) {
    ...
    public void setNegagiveTextColor(int colorID) {
        if (rightButton == null) {
            rightButton=  createButton(colorID);
            return;
        }
...
//		dividerParam.setMargins(dp10, 0, dp10, 0);
    ...
    private TextView createButton(int colorID) {
        TextView button = new TextView(context);
        button.setPadding(0, dp15, 0, dp15);
    ...
    private void layout() {
        ...
        if (messageView != null) {
            ...
            messageView.setLayoutParams(temp);
//            messageView.setGravity(Gravity.CENTER);
            contentLayout.addView(messageView, 0);
        }
