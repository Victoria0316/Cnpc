...
import com.bluemobi.cnpc.network.request.NewsInformationRequest;
...
@PageName(R.string.news_information)
public class NewsInformationFragment extends BaseFragment {
    ...
    public void getDataServer() {
        ...
        NewsInformationRequest request = new NewsInformationRequest
                (
                        new Response.Listener<NewsInformationResponse>() {
                            @Override
                            public void onResponse(NewsInformationResponse response) {
                                Utils.closeDialog();
            ...
            plv_refresh.getRefreshableView().setAdapter(
                    adapter = new CommonAdapter<SalesPromotionInfo>(mContext, dataList, R.layout.lv_find_item) {
                        ...
                        public void convert(ViewHolder helper, SalesPromotionInfo item) {
                            ...
                            Glide.with(mContext).load(item.getImagePath()).placeholder(R.drawable.info_bg)
                                    .into(iv_info);

                            tv_info_name.setText(item.getArtTitle());
