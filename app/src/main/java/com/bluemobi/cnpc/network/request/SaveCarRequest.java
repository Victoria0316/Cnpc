 ...
 * P10_1_1 添加爱车-新增车辆信息
 */
public class SaveCarRequest extends CnpcHttpJsonRequest<SaveCarResponse> {

    private static final String APIPATH = "mobi/carinfo/save";
    ...
    public SaveCarRequest(Response.Listener<SaveCarResponse> listener,
