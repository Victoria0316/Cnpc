 ...
 */
public class GasFillingCardBean implements Serializable {
    ...
    private List<GasFillingCardInfo> info;
    ...
    public List<GasFillingCardInfo> getInfo() {
        return info;
    }

    public void setInfo(List<GasFillingCardInfo> info) {
        this.info = info;
    }
}
