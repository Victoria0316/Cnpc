 ...
 * P5_2_1订单结算
 */
@ContentView(R.layout.activity_order_and_settlement)
@PageName(R.string.order_settlement)
public class OrderAndSettlementActivity extends BaseActivity implements View.OnClickListener, AlipayUtil.AlipayStausListener {
    ...
    protected void initBase() {
        ...
        titleBarManager.init(OrderAndSettlementActivity.this, getSupportActionBar());
    ...
    protected void successViewCompleted(View successView) {
        ...
        ctg_min_purchase.setRightText(Utils.StringTo2decimal(countNum) + "吨");

        ctg_min_increasing.setRightText(Utils.StringTo2decimal(RechargeAmount) + "元");
        ...
        ctg_procedure_fee.setRightText(Utils.StringTo2decimal(totalChangeAmount) + "元");

        ctg_actual_amount.setRightText(Utils.StringTo2decimal(String.valueOf(actualAmount)) + "元");

        ActAmount.setText(Utils.StringTo2decimal(String.valueOf(actualAmount)));
    ...
    private void getOtherPayAmount(boolean checked) {
        ...
        order_change_wallet_num.setText("¥" + Utils.StringTo2decimal(realCoinUse));

        changePreferential = String.valueOf(otherPayAmount.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
        order_pay_num.setText("¥" + Utils.StringTo2decimal(changePreferential));
    ...
    private void Settlement(int type) {
        ...
        OrderPaymentSuccessRequest request = new OrderPaymentSuccessRequest
                (
                            ...
                            public void onResponse(OrderPaymentSuccessResponse response) {
                                ...
                                if (response != null && response.getStatus() == 0) {
                                    ...
                                    if(response.getData() != null ){
                                        ...
                                        if (response != null && response.getStatus() == 0) {
                                            WxPayUtils.pay(OrderAndSettlementActivity.this, response.getData());
                                        } else {
                                        ...
                                        if(isAlipayChatPay){
                                            AlipayUtil alipayUtil = new AlipayUtil(OrderAndSettlementActivity.this, OrderAndSettlementActivity.this);
    ...
    private void ResetPay(int state) {
        ...
        ResetPayRequest request = new ResetPayRequest(new Response.Listener<ResetPayResponse>() {
            ...
            public void onResponse(ResetPayResponse response) {
                if (response != null && response.getStatus() == 0) {// success
                    ...
                    intent.setClass(mContext, OrderPaymentSuccessActivity.class);
        ...
        request.setUserId(CnpcApplication.getInstance().getmData().userId);
        request.setType("3");//类型 1优惠充值 2加油 3预购油购买 4零钱包充值 5借用油购买
        if(state == 1){
