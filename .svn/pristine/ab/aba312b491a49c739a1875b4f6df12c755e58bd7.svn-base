 ...
 */
@ContentView(R.layout.activity_pre_gas_transfer_success)
@PageName(R.string.mine_pre_transfer_success)
public class PreGasTransferSuccessActivity extends BaseActivity {
        ...
        PreGasTransferRequest request = new PreGasTransferRequest(new Response.Listener<PreGasTransferResponse>() {
            ...
            public void onResponse(PreGasTransferResponse response) {
                ...
                if (response != null && response.getStatus() == 0) {// success
                    ...
                    mine_pre_transfer_out_amount.setText(TotalSum+"元");//转出金额
                    mine_pre_transfer_out_amount_real.setText(data.getRealTotalPrice()+"元");//实际转出金额
