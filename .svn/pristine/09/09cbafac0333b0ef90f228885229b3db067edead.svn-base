...
public final class CnpcAlertDialog {
	...
	public CnpcAlertDialog(Context context) {
	...
	public CnpcAlertDialog addView(View v) {
	...
	public CnpcAlertDialog setTitle(String text) {
		if (titleView == null) {
	...
	public CnpcAlertDialog setMessage(String message) {
	...
	public CnpcAlertDialog setNegativeButtonClickListener(String text,
	...
	public CnpcAlertDialog setPositiveButtonClickListener(String text,
			OnClickListener listener) {
	...
	public CnpcAlertDialog setPositiveButtonText(String text) {
		if (leftButton == null) {
	...
	public CnpcAlertDialog setNegativeButtonText(String text) {
		if (rightButton == null) {
