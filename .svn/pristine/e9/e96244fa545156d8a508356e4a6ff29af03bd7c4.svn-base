...
public class SettlementBean implements Serializable {
    ...
    private String oilAmount; //油钱包优惠金额
    private String oilBalance;// "油钱包余额",
    ...
    public String getFrozenPayment() {
        return frozenPayment;
    }

    public void setFrozenPayment(String frozenPayment) {
        this.frozenPayment = frozenPayment;
    }
