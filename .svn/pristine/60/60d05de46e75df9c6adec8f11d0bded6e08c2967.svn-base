 ...
 */
public class NearNotBdGasStationResponse extends CnpcHttpResponse
{
    ...
    public static class NearnestGasStationInfo
    {
        ...
        public ArrayList<NearnestGasStationProductInfo> productInfoDTOs = new ArrayList<NearnestGasStationProductInfo>();
    }
